...
foreach ($result as $key => $row) {
    ...
    $activeWorksheet->setCellValue('A4', 'Kelas : ' . $row["nama_kelas"]);
    ...
    for ($i = 1; $i <= 31; $i++) {
        $columnLetter = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($i + 3);
    ...
    $activeWorksheet->getStyle('D5')->applyFromArray($styleBulan);
}
