    ...
    <div class="container p-3">
      ...
      <table class="table table-striped m-0 align-items-center">
        ...
        <tr>
            ...
            <th class="col-1" scope="col">rekap</th>
        ...
        <tbody id="data-table-body">
            ...
            while($d = mysqli_fetch_array($data)){
                ...
                echo "<td class='text-center'> Kelas 1A </td>";
                ...
                $rekap = ($rekapsakit + $rekapizin + $rekapalpha);
                ...
                echo "<td class='text-center'>" . $rekap . "</td>";
                echo "</tr>";
            }
            ?>
            ...
            while($d = mysqli_fetch_array($data)){
                ...
                echo "<td class='text-center'>" . $d["nis"] . "</td>";
                echo "<td class='text-start'>" . $d["nama"] . "</td>";
                echo "<td class='text-center'> Kelas 1B </td>";
                echo "<td class='text-center'>" . $d["jenis_kelamin"] . "</td>";
            ...
            while($d = mysqli_fetch_array($data)){
                ...
                echo "<td class='text-center'>" . $d["nis"] . "</td>";
                echo "<td class='text-start'>" . $d["nama"] . "</td>";
                echo "<td class='text-center'> Kelas 2A </td>";
                echo "<td class='text-center'>" . $d["jenis_kelamin"] . "</td>";
            ...
            while($d = mysqli_fetch_array($data)){
                ...
                echo "<td class='text-center'>" . $d["nis"] . "</td>";
                echo "<td class='text-start'>" . $d["nama"] . "</td>";
                echo "<td class='text-center'> Kelas 2B </td>";
                echo "<td class='text-center'>" . $d["jenis_kelamin"] . "</td>";
            ...
            while($d = mysqli_fetch_array($data)){
                ...
                echo "<td class='text-center'>" . $d["nis"] . "</td>";
                echo "<td class='text-start'>" . $d["nama"] . "</td>";
                echo "<td class='text-center'> Kelas 3A </td>";
                echo "<td class='text-center'>" . $d["jenis_kelamin"] . "</td>";
            ...
            while($d = mysqli_fetch_array($data)){
                ...
                echo "<td class='text-center'>" . $d["nis"] . "</td>";
                echo "<td class='text-start'>" . $d["nama"] . "</td>";
                echo "<td class='text-center'> Kelas 3B </td>";
                echo "<td class='text-center'>" . $d["jenis_kelamin"] . "</td>";
            ...
            while($d = mysqli_fetch_array($data)){
                ...
                echo "<td class='text-center'>" . $d["nis"] . "</td>";
                echo "<td class='text-start'>" . $d["nama"] . "</td>";
                echo "<td class='text-center'> Kelas 4 </td>";
                echo "<td class='text-center'>" . $d["jenis_kelamin"] . "</td>";
